...
def build_from_spec() -> Series:
    ...
    # Cold2
    ensure_defined(s, "Cold2", 4.0, 293.15); jump(s, "Cold2", 4.0, 272.70)
    hold_until(s, "Cold2", 8.0); ramp_to(s, "Cold2", 20.0, 272.42); hold_until(s, "Cold2", 28.0)
...
def plot_series(s: Series, save_png: Optional[str] = None):
    ...
    for name, a, b in PHASES:
        fig.text((a + b) / 2 / total_T, 1, name, ha="center", va="top", fontsize=18)
